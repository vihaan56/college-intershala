            ...
            <div className="internship_meta">
                ...
                <div className="intern_info">
                    ...
                    <i className="fas fa-info-circle"></i>
                        <span>
                            <a className="location_link" href="#!">{companydesc}</a>
                        </span>
                    </div>
                </div>
                ...
                <div className="internship_other_details_container">
                    <div className="other_detail_item_row">
                        <div className="other_detail_item large_stipend_text">
                            ...
                            <div className="item_body" id="start-date-first">
                                <span className="start_immediately_desktop">{noofseats}</span>
                            </div>
                        </div>
                    ...
                    <div className="other_detail_item_row">
                        <div className="other_detail_item large_stipend_text stipend_container">
                            <div className="item_heading">
                                <i className="fas fa-money-check"></i> <span>
                                    Stipend </span>
                            </div>
                            <div className="item_body">
                                <span className="stipend"><i className="ic-16-currency-inr"></i> {stipend} /month</span><i className="rewards_popover ic-16-help-circle"
                ...
                <div className="button_container">
                    ...
                    <a className="view_detail_button view_detail_anchor"
                        href={url}>
                        <div>Enroll Now</div>
